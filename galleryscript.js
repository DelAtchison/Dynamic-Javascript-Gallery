...
/* End of Gallery */
/* All other variables that exist on page load go here */
    ...
    //WORK ON THIS LATER U DUMB SHIT
    
    //function trygallery (){

        var imgpage = document.getElementById("imgpage")
    $(".thumbnail, .holdercontent").click(function(){  ///WE WANT TO REPLACE JQUERY HERE BUT FUCK THAT FOR NOW
        imgpage.style.cssText += "display:hidden;opacity:0;"; //not sure i need this
        ...
        var blaaaaaa = this.getAttribute("data-worksnumber");
